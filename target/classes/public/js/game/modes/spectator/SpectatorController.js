...
define(function(require){
  ...
  const WaitingForNextTurnState = require('./WaitingForNextTurnState');
  const CheckingForNextTurnState = require('./CheckingForNextTurnState');
