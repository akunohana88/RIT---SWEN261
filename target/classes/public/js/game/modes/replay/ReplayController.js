...
define(function(require){
  ...
  function ReplayController(view, gameState) {
    ...
    this.addStateDefinition(ReplayModeConstants.STARTING_REPLAY_MODE,
        new StartingReplayModeState(this, view, gameState));
    ...
    this.startup = function startup() {
      // start Replay mode
      this.setState(ReplayModeConstants.STARTING_REPLAY_MODE);
    };
   ...
   */
  ReplayController.prototype.canDeactivate = function canDeactivate() {
    return true;
  };
