...
/**
 * Test single piece object in the model tier.
 *
 * @author Hana Ho
 */
@Tag("Model-tier")
public class SinglePieceTest {
    ...
    SinglePiece piece = new SinglePiece(Color.RED, Piece.Type.SINGLE);
    ...
    public void testIsValidSimpleMove() {
        ...
        assertFalse(piece.isValidSimpleMove(move1));
    ...
    public void testIsValidSingleJump() {
        ...
        assertFalse(piece.isValidSingleJump(move4));
